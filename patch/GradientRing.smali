.class public final Lcom/phonetemp/app/ui/components/GradientRing;
...
.method private static brush(Lcom/phonetemp/app/ui/theme/PtColors;)Landroidx/compose/ui/graphics/Brush;
    ...
    invoke-virtual {p0}, Lcom/phonetemp/app/ui/theme/PtColors;->getStateCool-0d7_KjU()J
    move-result-wide v2
    const v4, 0x0    # 0.0000f
    ...
    invoke-virtual {p0}, Lcom/phonetemp/app/ui/theme/PtColors;->getStateCool-0d7_KjU()J
    move-result-wide v2
    const v4, 0x3daaaaab    # 0.0833f
    invoke-static {v4, v2, v3}, Lcom/phonetemp/app/ui/components/GradientRing;->stop(FJ)Lkotlin/Pair;
    move-result-object v5
    const/16 v0, 0x1
    aput-object v5, v1, v0

    invoke-virtual {p0}, Lcom/phonetemp/app/ui/theme/PtColors;->getStateNormal-0d7_KjU()J
    move-result-wide v2
    const v4, 0x3e555555    # 0.2083f
    invoke-static {v4, v2, v3}, Lcom/phonetemp/app/ui/components/GradientRing;->stop(FJ)Lkotlin/Pair;
    move-result-object v5
    const/16 v0, 0x2
    aput-object v5, v1, v0
    ...
    invoke-virtual {p0}, Lcom/phonetemp/app/ui/theme/PtColors;->getStateNormal-0d7_KjU()J
    move-result-wide v2
    const v4, 0x3f044444    # 0.5167f
    invoke-static {v4, v2, v3}, Lcom/phonetemp/app/ui/components/GradientRing;->stop(FJ)Lkotlin/Pair;
    move-result-object v5
    const/16 v0, 0x3
    aput-object v5, v1, v0

    invoke-virtual {p0}, Lcom/phonetemp/app/ui/theme/PtColors;->getStateWarm-0d7_KjU()J
    move-result-wide v2
    const v4, 0x3f222222    # 0.6333f
    invoke-static {v4, v2, v3}, Lcom/phonetemp/app/ui/components/GradientRing;->stop(FJ)Lkotlin/Pair;
    move-result-object v5
    const/16 v0, 0x4
    aput-object v5, v1, v0

    invoke-virtual {p0}, Lcom/phonetemp/app/ui/theme/PtColors;->getStateHot-0d7_KjU()J
    move-result-wide v2
    const v4, 0x3f39999a    # 0.7250f
    invoke-static {v4, v2, v3}, Lcom/phonetemp/app/ui/components/GradientRing;->stop(FJ)Lkotlin/Pair;
    move-result-object v5
    const/16 v0, 0x5
    aput-object v5, v1, v0

    invoke-virtual {p0}, Lcom/phonetemp/app/ui/theme/PtColors;->getStateCritical-0d7_KjU()J
    move-result-wide v2
    const v4, 0x3f555555    # 0.8333f
    invoke-static {v4, v2, v3}, Lcom/phonetemp/app/ui/components/GradientRing;->stop(FJ)Lkotlin/Pair;
    move-result-object v5
    const/16 v0, 0x6
    aput-object v5, v1, v0
...
.method public static draw(Landroidx/compose/ui/graphics/drawscope/DrawScope;Lcom/phonetemp/app/ui/theme/PtColors;F)V
    .locals 30
